...
distances = np.linalg.norm(df[indicators].values - centroids[labels], axis=1)

# Set a threshold for outliers
threshold = np.percentile(distances, 95)  # Adjust threshold as needed

# Filter outliers
df_km = df[distances <= threshold]
df_km.reset_index(inplace=True)
